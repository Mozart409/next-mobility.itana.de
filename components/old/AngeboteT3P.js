...
const Angebot = () => {
  ...
  const data = useStaticQuery(graphql`
    {
      ArtK: allT3PJson(filter: { Typ: { eq: "1" }, Art: { eq: "K" } }) {
        edges {
          node {
            Art
            Inklusivkilometer
      ...
      ArtL: allT3PJson(filter: { Typ: { eq: "1" }, Art: { eq: "L" } }) {
        edges {
          node {
            Art
            Inklusivkilometer
      ...
      ArtA: allT3PJson(filter: { Typ: { eq: "1" }, Art: { eq: "A" } }) {
        edges {
          node {
            Art
            Inklusivkilometer
      ...
      ArtS: allT3PJson(filter: { Typ: { eq: "1" }, Art: { eq: "S" } }) {
        edges {
          node {
            Art
            Inklusivkilometer
      ...
      ArtM: allT3PJson(filter: { Typ: { eq: "1" }, Art: { eq: "M" } }) {
        edges {
          node {
            Art
            Inklusivkilometer
