...
const Angebot = () => {
  ...
  const data = useStaticQuery(graphql`
    {
      ArtK: allTxlJson(filter: { Typ: { eq: "1" }, Art: { eq: "K" } }) {
        edges {
          node {
            Art
            Inklusivkilometer
      ...
      ArtL: allTxlJson(filter: { Typ: { eq: "1" }, Art: { eq: "L" } }) {
        edges {
          node {
            Art
            Inklusivkilometer
      ...
      ArtA: allTxlJson(filter: { Typ: { eq: "1" }, Art: { eq: "A" } }) {
        edges {
          node {
            Art
            Inklusivkilometer
      ...
      ArtS: allTxlJson(filter: { Typ: { eq: "1" }, Art: { eq: "S" } }) {
        edges {
          node {
            Art
            Inklusivkilometer
      ...
      ArtM: allTxlJson(filter: { Typ: { eq: "1" }, Art: { eq: "M" } }) {
        edges {
          node {
            Art
            Inklusivkilometer
