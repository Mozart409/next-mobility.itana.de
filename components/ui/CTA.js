      ...
      <button
        className={cx(
          'static z-50 w-full py-2 mt-2 font-semibold uppercase rounded-full transition duration-150 ease-in-out',
          {
            ...
            'border border-itana-red text-black hover:bg-red-500 hover:text-white focus:outline-none focus:shadow-outline': !props.fillBG,
...
CTA.defaultProps = {
  link: 'https://reservation.itana.de/',
