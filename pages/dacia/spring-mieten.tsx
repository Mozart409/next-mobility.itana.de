import {DaciaSpringPrice, ModelYLongRange} from 'lib/car-prices';
...
function DaciaSpringPage() {
  return (
    <div>
      <SEO
        title={`Dacia Spring mieten | ab ${DaciaSpringPrice['Verlängerungstag 100 km']}
        / Tag`}
        description="Dacia Spring mieten | Bester Autoverleih | App Zugang auf ihrem Smartphone | SUV genießen ► Mo-Fr von 8-18 Uhr | Jetzt anfragen ☎ +49 711 49066 450"
      />
      <Head>
        <link
          rel="canonical"
      ...
      <section>
        ...
        <h2>Dacias erstes vollelektrisches Auto</h2>

        <div className="max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl">
          <div className="mx-auto">
            <div className="relative">
              <Link href="#dacia-spring" aria-label="Dacia Spring">
                <a title="Dacia Spring">
                  <Image
      ...
      <section>
        <CTA
          ...
          fillBG={true}
          fullWidth={true}
          title="Dacia Spring mieten"
        />
      </section>
      <TeslaQuickLinks />
      <section>
        <CarPrices data={DaciaSpringPrice} />
      </section>
...
export default DaciaSpringPage;
