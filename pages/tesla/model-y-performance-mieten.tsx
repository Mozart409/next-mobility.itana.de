import {ModelYPerformance} from 'lib/car-prices';
...
function TeslaModelYPerformance() {
  return (
    <div>
      <SEO
        title={`Tesla Model Y Performance mieten | ab ${ModelYPerformance['Verlängerungstag 100 km']}
        / Tag`}
        description="Tesla Model Y Performance mieten | Bester Autoverleih | App Zugang auf ihrem Smartphone | SUV genießen ► Mo-Fr von 8-18 Uhr | Jetzt anfragen ☎ +49 711 49066 450"
      />
      <Head>
        <link
          rel="canonical"
      ...
      <section>
        <h1 className="text-xl font-bold leading-6 tracking-tight text-gray-900 sm:text-2xl sm:leading-8">
          Tesla Model Y Performance mieten
        </h1>
        ...
        <div className="max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl">
          <div className="mx-auto">
            <div className="relative">
              <Link
                href="#tesla-model-y-performance"
                aria-label="Tesla Model Y Performance"
              >
                <a title="Tesla Model Y Performance">
                  <Image
                    src="/images/cards/tesla-model-y-performance.png"
                    className="mx-auto mt-4 h-96 rounded"
                    alt="Tesla Model Y Performance mieten"
                    height="600"
                    width="1000"
                  />
                </a>
      ...
      <section>
        <CTA
          data_cy="TeslaModelYPerformanceMieten"
          fillBG={true}
          fullWidth={true}
          title="Tesla Model Y Performance mieten"
        />
      </section>
      <TeslaQuickLinks />
      <section>
        <CarPrices data={ModelYPerformance} />
      </section>
...
export default TeslaModelYPerformance;
